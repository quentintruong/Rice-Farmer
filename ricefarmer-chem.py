...
class RiceSpider(scrapy.Spider):
    ...
    def parseRice(self, response):
        ...
        option[0] = Selector(text=riceSRC).xpath('//div[@id="question-title"]/a/b/text()').extract()[0]
        option[1] = Selector(text=riceSRC).xpath('//a[@class="answer-item" and @rel="0"]/text()').extract()[0]
        option[2] = Selector(text=riceSRC).xpath('//a[@class="answer-item" and @rel="1"]/text()').extract()[0]
        option[3] = Selector(text=riceSRC).xpath('//a[@class="answer-item" and @rel="2"]/text()').extract()[0]
        option[4] = Selector(text=riceSRC).xpath('//a[@class="answer-item" and @rel="3"]/text()').extract()[0]
